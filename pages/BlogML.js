...
import {BlogMLArticles, nodeExperiences, reactProjects, reactNativeProjects, angularProjects, nodeProjects, nocodeProjects} from '../profile'
            ...
            <div className="card card-body bg-primary">
                <div className="row">
                    <div className="col-md-12 border-bottom">
                        <h1 className="text-center text-light">Machine Learning</h1>
                    </div>
                    ...
                    {
                          BlogMLArticles.map(({name,description,image,link},i) => (
